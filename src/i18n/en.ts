...
export const en = {
  ...
  pages: {
    ...
    doctorDashboard: {
      ...
      // 2026-08-27: sidebar app-shell (Overview/Appointments/Patients/
      // Messages) added around the dashboard — see doctor-dashboard.tsx.
      shell: {
        ...
        overviewSubtitle: 'Your account, booking link, and upcoming appointments at a glance.',
        appointmentsTitle: 'Appointments',
        appointmentsSubtitle: "Track your patients' appointments for the day and follow up on cancellations.",
        patientsTitle: 'Patients',
        patientsSubtitle: "Everyone you've seen through Pelmatech.",
        // {count} is replaced at render time.
        patientsCountLabel: '{count} appointments',
        noPatients: 'No patients yet.',
        messagesTitle: 'Messages',
        messagesSubtitle: 'Direct messages with your patients.',
        messagesComingSoon: "Messaging isn't built yet — it's coming to Pelmatech soon.",
