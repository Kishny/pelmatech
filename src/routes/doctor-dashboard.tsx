...
function DoctorDashboard() {
  ...
  const sectionTransition = prefersReducedMotion ? { duration: 0 } : { duration: 0.35, ease: [0.22, 1, 0.36, 1] as const }
...
function OverviewSection({
  ...
  return (
    <div>
      ...
      <AnimatedText className="mt-2 text-sm text-muted-foreground">{shell.overviewSubtitle}</AnimatedText>
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-border bg-background p-6">
          <div className="flex items-center gap-2.5">
            <span
              ...
              style={{ backgroundColor: 'color-mix(in oklch, var(--accent) 16%, var(--background))', color: 'var(--accent)' }}
            >
        ...
        <div className="rounded-2xl border border-border bg-background p-6">
          <div className="flex items-center gap-2.5">
            <span
              className="flex h-8 w-8 items-center justify-center rounded-full"
              style={{ backgroundColor: 'color-mix(in oklch, oklch(0.55 0.12 250) 16%, var(--background))', color: 'oklch(0.55 0.12 250)' }}
            >
        ...
        <div className="rounded-2xl border border-border bg-background p-6 md:col-span-2">
          <div className="flex items-center gap-2.5">
            <span
              className="flex h-8 w-8 items-center justify-center rounded-full"
              style={{ backgroundColor: 'color-mix(in oklch, oklch(0.55 0.12 200) 16%, var(--background))', color: 'oklch(0.55 0.12 200)' }}
            >
              ...
              {upcoming.map((a, i) => (
                ...
                >
                  <button
                    ...
                    className="flex w-full flex-wrap items-center justify-between gap-2 rounded-xl px-2 py-2.5 text-left transition hover:bg-muted"
                  >
                    <div className="flex items-center gap-2.5">
                      <span
                        className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[11px] font-semibold text-accent-foreground"
...
function AppointmentsSection({
  ...
  return (
    <div>
      ...
      <AnimatedText className="mt-2 text-sm text-muted-foreground">{shell.appointmentsSubtitle}</AnimatedText>
      ...
      <div className="mt-8 grid grid-cols-1 gap-8 xl:grid-cols-[340px_1fr]">
        <div>
              ...
              {cells.map((d, i) => {
                ...
                return (
                  <button
                    ...
                    className={
                      'relative mx-auto flex h-8 w-8 items-center justify-center rounded-full text-sm transition hover:scale-110 ' +
                      (isSelected
          ...
          <motion.div
            key={`${dayKey(selectedDate)}-${typeFilter}-stats`}
          ...
          <div className="relative flex flex-wrap items-center gap-2">
            {(['all', 'inPerson', 'video'] as const).map((key) => (
              <button
                ...
                className={
                  'relative flex items-center gap-1.5 rounded-full border px-4 py-1.5 text-sm font-medium transition ' +
                  (typeFilter === key ? 'border-accent text-accent' : 'border-border text-muted-foreground hover:text-foreground')
                }
              >
                {typeFilter === key && (
                  <motion.span
                    layoutId="appointment-type-pill"
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: `color-mix(in oklch, ${color} 6%, var(--background))`,
      }}
    >
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <span
            className="flex h-8 w-8 items-center justify-center rounded-full"
            style={{ backgroundColor: `color-mix(in oklch, ${color} 18%, var(--background))`, color }}
          >
        ...
        <div className="flex gap-[3px]">
          {Array.from({ length: Math.min(bars, 24) }, (_, i) => (
            <motion.span
              ...
              initial={{ height: 0 }}
              animate={{ height: 16 }}
              transition={{ duration: 0.3, delay: 0.15 + i * 0.015, ease: [0.22, 1, 0.36, 1] }}
            />
          ))}
        </div>
      </div>
    ...
    <div>
      <div className="flex items-center gap-2 text-sm font-medium">
        ...
        <span
          ...
          style={{ backgroundColor: `color-mix(in oklch, ${color} 14%, var(--background))`, color }}
        >
          {items.length}
        </span>
      </div>
...
function PatientsSection({
  ...
  return (
    <div>
      ...
      <AnimatedText className="mt-2 text-sm text-muted-foreground">{shell.patientsSubtitle}</AnimatedText>
...
function MessagesSection({ shell }: { shell: DoctorDashboardShell }) {
  return (
    <div>
      ...
      <AnimatedText className="mt-2 text-sm text-muted-foreground">{shell.messagesSubtitle}</AnimatedText>
      <div className="mt-8 flex max-w-2xl flex-col items-center gap-3 rounded-2xl border border-dashed border-border p-12 text-center">
        <span
          ...
          style={{ backgroundColor: 'color-mix(in oklch, var(--accent) 14%, var(--background))', color: 'var(--accent)' }}
        >
